...
const HeritageMapComponent = dynamic(() => import('@/components/ui/HeritageMap'), {
  ssr: false,
  loading: () => (
...
export default function HeritageMapClient({ initialSites }: { initialSites: any[] }) {
  return <HeritageMapComponent initialSites={initialSites} />;
}
