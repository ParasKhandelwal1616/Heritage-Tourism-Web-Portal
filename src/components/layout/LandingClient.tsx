...
const LandingClient = ({ destinations, videoUrl, stats }: LandingClientProps) => {
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="py-20 md:py-32 px-4 md:px-6 max-w-7xl mx-auto overflow-hidden">
        <motion.div
        ...
        >
          <span className="text-saffron font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[10px] md:text-xs mb-4 block">
            Curated Experiences
          </span>
          <h2 className="font-serif text-4xl md:text-7xl font-black text-charcoal mb-6">
      ...
      <section className="py-16 md:py-24 bg-ash border-y border-black/5">
